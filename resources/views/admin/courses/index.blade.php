...
<div class="mb-8 rounded-2xl relative overflow-hidden animate-fade-up"
    ...
    <div class="relative p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6 z-10 w-full flex-wrap">
        <div>
            <h1 class="text-3xl font-black mb-2 tracking-tight text-white">Browse Courses</h1>
...
<div class="flex items-center justify-between mb-6 animate-fade-up delay-1">
    <h2 class="text-xl font-bold tracking-tight">Course Catalog</h2>
</div>
                    ...
                    <td class="pr-6 text-right">
                        <div class="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                            ...
                            <form method="POST" action="{{ route('admin.courses.destroy', $course) }}"
                                  onsubmit="confirmCourseDelete(event, this)" class="inline-block">
                                @csrf @method('DELETE')
...
<div id="bulkBar" class="bulk-bar">
    ...
    <form id="bulkDeleteForm" method="POST" action="{{ route('admin.courses.bulk-delete') }}" onsubmit="event.preventDefault(); confirmBulkDelete();">
        @csrf
        @method('DELETE')
...
(function () {
    ...
    window.confirmBulkDelete = function () {
        ...
        Swal.fire({
            title: 'Are you sure?',
            text: `Delete ${n} selected course${n > 1 ? 's' : ''}? This action cannot be undone.`,
            icon: 'warning',
    ...
    window.confirmCourseDelete = function (e, form) {
        e.preventDefault();
        Swal.fire({
            title: 'Delete this course?',
            text: 'This may affect active enrollments. This action cannot be undone.',
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#ef4444',
            cancelButtonColor: 'rgba(255,255,255,0.1)',
